        ...
        StringRequest request = new StringRequest(Request.Method.POST, Constant.LOGIN,response -> {
            ...
            try {
                ...
                if (object.getBoolean("success")){
                    ...
                    editor.putString("addressNo",user.getString("addressNo"));
                    editor.putString("street",user.getString("street"));
                    editor.putString("addressZone",user.getString("addressZone"));
                    editor.putString("phoneNum",user.getString("phoneNum"));

                    editor.putString("valid_id",user.getString("avatar"));
...
//                  editor.putBoolean("isLoggedIn",true);
                    ...
                    //if success
                    startActivity(new Intent(((AuthActivity)getContext()), UserActivity.class));
