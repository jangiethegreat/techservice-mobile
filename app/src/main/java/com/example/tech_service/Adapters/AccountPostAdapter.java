...
//
//    public AccountPostAdapter(Context context, ArrayList<announcement> arrayList) {
...
//        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_account,parent,false);
